...
public class TestSolrTemplate {
    ...
    public void testAddList() {
        ...
        //循环插入100条数据
        for (int i = 0; i < 100; i++) {
            Goods goods = new Goods(i + 1L, "华为Mate00" + i, BigDecimal.valueOf(2000.0 + i), "手机", "手机", "华为专卖店");
            list.add(goods);
        }
...
//        showList(list);
    ...
    public void testPageQueryMutil() {
        ...
        Criteria criteria = new Criteria("item_title").contains("pia");
    ...
    public void testFilterQuery() {
        ...
        if (!map.get("keywords").equals("") && map.get("keywords") != null) {
            criteria.contains(map.get("keywords").toString());
        }
        query.addCriteria(criteria);
