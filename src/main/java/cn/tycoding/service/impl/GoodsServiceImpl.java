...
//        return goodsMapper.findAll();
    ...
    public PageBean findByPage(Goods goods, int pageCode, int pageSize) {
        ...
        System.out.println("---------------------------findByPagefindByPagefindByPagefindByPagefindByPagefindByPage");
    ...
    private Map searchList(Map searchMap) {
        System.out.println("---------------------searchListsearchListsearchListsearchListsearchListsearchList");
        Map map = new HashMap();
